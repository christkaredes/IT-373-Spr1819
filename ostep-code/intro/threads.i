...
# 11 "common.h"
   "rc == 0"
# 11 "common.h" 3 4
   , "common.h", 11, __PRETTY_FUNCTION__))
# 11 "common.h"
                  ;
...
# 25 "threads.c"
   "pthread_create(&p1, ((void *)0), worker, ((void *)0)) == 0"
# 25 "threads.c" 3 4
   , "threads.c", 25, __PRETTY_FUNCTION__))
# 25 "threads.c"
   ;;
...
# 26 "threads.c"
   "pthread_create(&p2, ((void *)0), worker, ((void *)0)) == 0"
# 26 "threads.c" 3 4
   , "threads.c", 26, __PRETTY_FUNCTION__))
# 26 "threads.c"
   ;;
...
# 27 "threads.c"
   "pthread_join(p1, ((void *)0)) == 0"
# 27 "threads.c" 3 4
   , "threads.c", 27, __PRETTY_FUNCTION__))
# 27 "threads.c"
   ;;
...
# 28 "threads.c"
   "pthread_join(p2, ((void *)0)) == 0"
# 28 "threads.c" 3 4
   , "threads.c", 28, __PRETTY_FUNCTION__))
# 28 "threads.c"
   ;;
